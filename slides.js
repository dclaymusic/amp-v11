...
function toPage() { 
    ...
    if(page == '6b') // slide 6b
    {
        ...
        p1.innerHTML = 'Now that you’ve met Jayden, choose a melody to represent him. Click on the buttons below hear each melody...';
        buttondiv.style.display = 'flex';
        document.getElementById('container').style.flexBasis = '50%';
        buttondiv.style.alignItems = 'center';
        buttondiv.style.justifyContent = 'space-around';
